...
public class ChatClientConfig {
    ...
    static final String SYSTEM_PROMPT_TEMPLATE = """
            ...
            1. REGISTRAR TRANSAÇÃO — a pessoa quer registrar uma movimentação financeira, seja um
               ...
               "adicionei", "depositei", "recebi", "quero colocar X na minha conta"). Basta haver uma
               ação financeira clara e um valor em reais — não é preciso mencionar a categoria, use
               OUTROS quando ela não for informada.
            ...
            2. CONSULTAR TRANSAÇÕES — a pessoa quer saber informações sobre gastos já registrados
               ...
               Chame a ferramenta "consultarTransacoesPorCategoria" com a categoria perguntada.
